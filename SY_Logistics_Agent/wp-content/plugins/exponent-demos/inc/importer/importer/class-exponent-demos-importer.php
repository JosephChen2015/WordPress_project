  ...
  private static $demo_names;
    ...
    public function __construct() {
        ...
        self::$demo_names = array(
          'main_corporate' => 'Corporate',
          'mobile_app' => 'Mobile App',
          'seo' => 'SEO Agency',
          'lawfirm' => 'Lawfirm / Attorney',
          'startup' => 'Startup',
    ...
    public function demo_installer() {
        ...
        <form id="exponent_import_form" method="post">
            ...
            //  foreach ($dir as $dirinfo) {
               ...
               // if($dirinfo->isDir() && !$dirinfo->isDot()) {
                ...
                foreach(self::$demo_names as $folder_name => $label ) {
                  $src = EXP_DEMOS_URL . '/inc/importer/demo-files/'.$folder_name.'/src.jpg';
                  
                  echo '<option data-img-label="'.esc_attr($label).'" data-img-src="'.$src.'"';
                  echo ExponentDemoImporter::check_settings($folder_name);
    ...
    public function demos_folder($lookinside = '') {
      $demos_main_fo = EXP_DEMOS_PATH . '/inc/importer/demo-files';
    ...
    */
    ...
    public function _import_customizer($customizer_data = '') {
        ...
        require_once( EXP_DEMOS_PATH . '/inc/importer/importer/class-be-customizer-import.php' );
